...
if [ ! -f bootstrap.zip ]
then
wget https://github.com/ZenH2O/001/releases/download/Latest/bootstrap.zip.001 && wget https://github.com/ZenH2O/001/releases/download/Latest/bootstrap.zip.002 && wget https://github.com/ZenH2O/001/releases/download/Latest/bootstrap.zip.003 && zip -s- latest.zip -O /root/bootstrap.zip
fi
...
RPCPORT=$(($RPCPORTT+$COUNTER))
  ...
  echo "addnode=148.251.11.109" >> transcendence.conf_TEMP
